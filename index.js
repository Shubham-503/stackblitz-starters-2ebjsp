...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  if (growth.toLowerCase() === 'high-to-low') {
    stocksCopy.sort((a, b) => b.growth - a.growth);
  } else if (growth.toLowerCase() === 'low-to-high') {
...
app.get('/stocks/filter/exchange', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  let stocksByExchange = filterByExchange(stocksCopy, exchange);
  res.json({ stocks: stocksByExchange });
});
...
app.get('/stocks/filter/industry', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  let stocksByIndustry = filterByIndustry(stocksCopy, industry);
  res.json({ stocks: stocksByIndustry });
});
